...
def cleanData():
    ...
    #Cleans scraped Tim Ferris data
    def timClean():
    ...
    def richClean():
        ...
        #location of the image for use in the flask template
        df_Rich['Image'] = 'static/Rich.jpg'
        return df_Rich
    ...
    def oneMerge():
        ...
        df_JRE = JRE_Clean()
        df_shane = getShane()
        df_clean = pd.concat([df_Rich,df_Tim,df_JRE,df_shane])
