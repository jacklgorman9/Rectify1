# -*- coding: utf-8 -*-
"""
Created on Wed Sep 30 23:18:49 2020

@author: jackl
"""

def podcastModelTopic(picker):
    import pandas as pd
    ...
    #modeling
    tfid = TfidfVectorizer(stop_words='english') #usetfid to call out words and names that are prominent in a bio
    ...
    index = np.where(df_clean['Description'] == picker)[0][0]
    ...
    final_reccomendations = rec[['ID','Episode','Description','Link','Podcast Name']]
